  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="tingkat_kelas_create">Kelas Tingkat:</label>
            <input required type="" name="tingkat_kelas" id="tingkat_kelas_create" class="form-control">
          </div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="tingkat_kelas_edit">Kelas Tingkat:</label>
            <input type="" name="tingkat_kelas" id="tingkat_kelas_edit" class="form-control">
          </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">CLOSE</button>
