...
<div class="login-box" style="margin-bottom: 20vh;">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <img src="{{ asset('/logopendidikan.jpg') }}" alt="" style="max-width: 190px; display: block; margin: 0 auto;">
      ...
      <form action="{{ route('login') }}" method="post">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col">
            <button type="submit" class="btn btn-primary btn-block" style="background : #0A2558">Login</button>
          </div>
          <!-- /.col -->
        </div>
        <div class="text sign-up-text" style="margin-top: 50px;">
                                Anda lupa password? 
