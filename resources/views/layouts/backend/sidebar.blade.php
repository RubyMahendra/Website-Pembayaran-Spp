<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <!-- Sidebar -->
  <div class="sidebar" style = "background-color: #0A2558">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a style="font-size: 20px;"  class="d-block">{{ Auth::user()->username }}</a>
        <span class="d-block" style = "color: white; font-size: 20px;" href="#">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{ route('siswa.pengajuan-kendala') }}" class="nav-link {{ Request::segment(1) == 'pengajuan-kendala' ?  : '' }}">
        ...
        <li class="nav-item">
    <a href="{{ route('email.emailpemberitahuan') }}" class="nav-link {{ Request::segment(2) == 'emailpemberitahuan' ? 'active' : '' }}">
        <i class="nav-icon fas fa-envelope"></i>
        <p>
            Email
        </p>
...
<li class="nav-item">
    <a href="{{ route('pengajuankendala.index') }}" class="nav-link {{ Request::is('pengajuankendala/index') ?  : '' }}">
        <i class="nav-icon fas fa-envelope"></i>
        <p>
            Pengajuan Kendala
        </p>
