...
use App\Http\Controllers\Auth\EmailPemberitahuanController;
use App\Http\Controllers\Auth\PengajuanKendalaController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::get('email/emailpemberitahuan', function () {
    return view('emails.emailpemberitahuan');
})->name('email.emailpemberitahuan');

Route::get('email/emailpemberitahuan', function () {
    return view('emails.emailpemberitahuan');
})->name('email.emailpemberitahuan');

Route::post('/email-pemberitahuan', [EmailPemberitahuanController::class, 'send'])->name('emailpemberitahuan.email');

Route::get('siswa/pengajuan-kendala', function () {
    return view('siswa.pengajuan-kendala');
})->name('siswa.pengajuan-kendala');

// Kirim pengajuan kendala
Route::post('siswa/pengajuan-kendala', [PengajuanKendalaController::class, 'kirimPengajuan'])->name('pengajuankendala.kirimPengajuan');

// Daftar pengajuan kendala
Route::get('pengajuankendala/index', [PengajuanKendalaController::class, 'index'])->name('pengajuankendala.index');

// Update the route to accept only the 'id' parameter
Route::put('/pengajuan-kendala/{id}', [PengajuanKendalaController::class, 'updateStatus'])->name('pengajuan-kendala.update-status');

Route::put('/pengajuan-kendala/{id}/update-status', [PengajuanKendalaController::class, 'updateStatus'])->name('pengajuan-kendala.update-status');
